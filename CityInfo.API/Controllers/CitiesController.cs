...
namespace CityInfo.API.Controllers
{
    ...
    //CitiesController class is an API controller
    [ApiController]

    [ApiVersion(1)]
    [ApiVersion(2)]

    //ControllerBase is the base class for API controllers in ASP.NET Core
    public class CitiesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<CityWithoutPointsOfIntrestDto>>> GetCities([FromQuery]string? name, string? searchQuery, int pageNumber = 1, int pageSize = 10)
        {
